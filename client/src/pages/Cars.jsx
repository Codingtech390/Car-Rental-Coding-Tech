  ...
  return (
    <div>
      <div className="flex flex-col items-center py-20 bg-light max-md:px-4">
        ...
        {/* Searchbox */}
        <div className="flex items-center bg-white px-4 mt-6 max-w-140 w-full h-12 rounded-full shadow-lg">
          <img
          ...
          <input
            ...
            className="w-full h-full outline-none text-sm text-gray-500 placeholder:text-gray-400"
          />
